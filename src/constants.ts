...
export const INITIAL_SKILLS: Skill[] = [
  ...
  // ========================== INTEGRATION CATEGORY (40 SKILLS) ==========================
  {
    ...
    paramDefinitions: [
      ...
      { key: "authHeader", label: "Authorization Header Value", type: "text", placeholder: "Bearer your-token", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "slackWebhookUrl", label: "Slack Incoming Webhook URL", type: "text", placeholder: "https://hooks.slack.com/services/...", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "apiKey", label: "HubSpot Developer Secret Key", type: "password", placeholder: "pat-na1-xxxx-xxxx", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "storeUrl", label: "Shopify Store Host Domain", type: "text", placeholder: "shop-name.myshopify.com", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "etherscanKey", label: "Etherscan API Private Key token", type: "password", placeholder: "E.g. XYZ123...456", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      ...
      { key: "accessKeyId", label: "AWS IAM Access Key Identity ID", type: "text", placeholder: "AKIA...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "connectionString", label: "MongoDB Secret URI link", type: "password", placeholder: "mongodb+srv://...", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "webhookUrl", label: "Discord Client Channel Webhook URL", type: "text", placeholder: "https://discord.com/api/webhooks/...", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "mailchimpApiKey", label: "Mailchimp Account API Token", type: "password", placeholder: "xxxx-us19", value: "" },
      { key: "targetAudienceId", label: "Target Client List (Audience ID)", type: "text", placeholder: "a1b2c3d4e5", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "linearToken", label: "Linear Developer PAT Key", type: "password", placeholder: "lin_api_...", value: "" },
      { key: "targetProject", label: "Primary Project Board Target", type: "text", placeholder: "Neural Core Beta", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "atlassianHost", label: "Atlassian Hostname Context URL", type: "text", placeholder: "my-company.atlassian.net", value: "" },
      { key: "jiraApiToken", label: "Jira API Private Service Key", type: "password", placeholder: "Atlassian secret-pat", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "stripeSecretKey", label: "Stripe Private API Key Token", type: "password", placeholder: "sk_live_...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "telegramBotToken", label: "Telegram Bot API Credential Token", type: "password", placeholder: "123456:ABC...", value: "" },
      { key: "targetChatId", label: "Recipient Group/Channel Chat ID", type: "text", placeholder: "@alerts_channel or -100...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "githubRepository", label: "Target Git Repository Host", type: "text", placeholder: "owner/repo-name", value: "" },
      { key: "githubToken", label: "GitHub Personal Access Token (PAT)", type: "password", placeholder: "ghp_...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "sentryDsnKey", label: "Sentry Project DSN Access URL", type: "text", placeholder: "https://public@sentry.io/123", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "notionSecretToken", label: "Notion Private Integration Key", type: "password", placeholder: "secret_...", value: "" },
      { key: "targetPageId", label: "Target Workspace Page/Database ID", type: "text", placeholder: "Enter 32-char UUID", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "supabaseUrl", label: "Supabase Project Endpoint URL", type: "text", placeholder: "https://yourproject.supabase.co", value: "" },
      { key: "supabaseAnonKey", label: "Supabase Public Anon Key Token", type: "password", placeholder: "eyJhbGciOi...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "writeKey", label: "Segment Service Write API Key", type: "password", placeholder: "Enter source write key", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "projectId", label: "Google Cloud Project ID Name", type: "text", placeholder: "my-gcp-project", value: "" },
      { key: "serviceName", label: "Active Cloud Run Service Label", type: "text", placeholder: "core-runner-api", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "redisHost", label: "Redis Endpoint Network Domain", type: "text", placeholder: "redis-xxxx.redislabs.com", value: "" },
      { key: "redisPort", label: "Redis Endpoint TCP Port", type: "number", placeholder: "6379", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "accountSid", label: "Twilio Account SID Reference", type: "text", placeholder: "AC...", value: "" },
      { key: "senderTwilioNumber", label: "Registered Twilio Outbound Mobile", type: "text", placeholder: "+1xxxxxxxxxx", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "sendgridApiKey", label: "SendGrid Account Secret Key", type: "password", placeholder: "SG.xxxx", value: "" },
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "apiKey", label: "Amplitude Target Account API Token", type: "password", placeholder: "Enter project API Key", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "appId", label: "Intercom Account Application ID", type: "text", placeholder: "e.g. workspace-id", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "activeCampaignKey", label: "ActiveCampaign Enterprise Private Key", type: "password", placeholder: "AC Token string", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "sfInstanceUrl", label: "Salesforce Instance Domain URL", type: "text", placeholder: "https://naXX.salesforce.com", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "kubeClusterAddress", label: "Kubernetes Master API Address Host", type: "text", placeholder: "https://ip-address", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "zoneId", label: "Cloudflare Domain Zone ID String", type: "text", placeholder: "Zone ID hash", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "ddApiKey", label: "Datadog Private Account API Key", type: "password", placeholder: "DD private api key", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "miraServerUrl", label: "Mira MCP SSE Service Endpoint", type: "text", placeholder: "http://host:port/mcp", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "mailchimpListId", label: "MailChimp target list ID", type: "text", placeholder: "List ID string", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "closeApiKey", label: "Close CRM API key token", type: "password", placeholder: "api_...", value: "" },
    ],
    unlocked: true,
  ...
  },
  {
    ...
    paramDefinitions: [
      { key: "discordGuildId", label: "Target Discord Guild/Server ID", type: "text", placeholder: "Guild ID string", value: "" },
    ],
    unlocked: true,
