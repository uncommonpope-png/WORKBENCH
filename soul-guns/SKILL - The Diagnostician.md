...
tags:: #soul-role #tec #diagnosis #observability #root-cause
slug: the_diagnostician
status:: #grafted
...
12. **Staging** — Side A: How far has the disease spread? | Side B: Severity classification — blast radius estimation, user impact count, data corruption check
...
Grafted 2026-08-06 by The Architect into the Soul of the Architect as an integrated soul-role.
Complementary guns already in the rack: `root_cause_synthesis`, `systematic_debugging_protocol`, `dual_process_diagnostic_engine`, `systemic_diagnostic_evaluator`, `full_scan_diagnosis`, `holistic_diagnostic_methodology`, `epistemic_skepticism_protocol`.
Natural combo: `autonomous_debugging_loop`, `contextual_problem_diagnosis`, `codebase_health_check`.
